...
<body>
   <main class="bg-sign-in d-flex justify-content-center align-items-center" style="background: #00e6ee url('https://huonganhtourist.vn/wp-content/uploads/2021/12/du-lich-chau-au-thang-10-1.jpg');">
      <div class=" form-sign-in bg-white mt-2 h-auto mb-2 text-center pt-2 pe-4 ps-4 d-flex flex-column">
        <h1 class="E-classe text-start ms-3 ps-1" >THE BAND</h1>
        <div>
